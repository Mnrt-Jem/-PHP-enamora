...
class anblog extends Module
{
    ...
    public function installImageTypes()
    {
        ...
        $imageType->name = 'anblog_default';
        $imageType->width = 885;
        $imageType->height = 620;
        ...
        $imageType->name = 'anblog_thumb';
        $imageType->width = 885;
        $imageType->height = 620;
        $res &= $imageType->add();

        $imageType->name = 'anblog_listing_leading_img';// post in cat and widget of home
        $imageType->width = 405;
        $imageType->height = 285;
        $res &= $imageType->add();

        $imageType->name = 'anblog_listing_secondary_img';//
        $imageType->width = 253;
        $imageType->height = 177;
        $res &= $imageType->add();
