...
<div class="an_productattributes-product-selectbox js-an_productattributes-product-selectbox an_productattributes-dropdown">
	<div class="an_productattributes-dropdown-toggler">
		<div class="js-an_productattributes-filter-option">{l s='Select variant' d='Shop.Theme.Global'} </div>
	</div>
	<div class="an_productattributes-dropdown-menu">
		<ul>
			{foreach from=$productData key=k item=v name=fodata}
			<li role="option" data-value="{$k|intval}"{if !$v.availableForOrder} class="an_productattributes-select-sold-out"{/if}>
				...
				<span class="an_productattributes-select-sold-out" style="background: {$config.background_sold_out}; color: {$config.color_sold_out};">{l s='Sold out' d='Shop.Theme.Global'}</span>
				{/if}
				...
				<span class="an_productattributes-select-sale" style="background: {$config.background_sale}; color: {$config.color_sale};">{l s='Save' d='Shop.Theme.Global'} {$v.prices.discount_amount}
				{/if}				
				</span>
				{/if}				
			</li>
